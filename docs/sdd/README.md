...
| `architecture.md` | UI、状態、バックエンド、Snapshot の実装構造を定義する。 |
...
| `grill.md` | 仕様更新時のレビュー手順。仕様を安易に広げないためのチェックリスト。 |
| `agent_handoff.md` | 実装エージェントへ渡すための短い作業指示。 |
| `AGENTS.md` | `docs/sdd/` 配下で作業する実装エージェント向けのローカル規則。 |
